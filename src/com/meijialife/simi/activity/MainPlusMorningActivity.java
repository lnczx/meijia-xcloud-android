 ...
 * 
 */
public class MainPlusMorningActivity extends BaseActivity implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        case R.id.layout_select_phonenumber:// 选择通讯录
            Intent intent = new Intent(MainPlusMorningActivity.this, ContactSelectActivity.class);
...
//              if (mYear < year || mMonth < month || mDay < day || mhour < hour || mMinu < minute) {
    ...
    private void createCard(boolean update) {
        ...
        String c_id = DBHelper.getUser(MainPlusMorningActivity.this).getId();
